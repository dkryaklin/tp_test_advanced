    ...
    return (
      <div className="widget">
        ...
        <div className="content">
            ...
            <div className="long_message"><div>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</div></div>

            <div className="date_picker">
                <input className="date_input" size="1" type="text" placeholder="Depart date" />
                <div className="icon_wrapper"><img src={calendar} alt="" /></div>
            </div>
